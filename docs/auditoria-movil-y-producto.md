...
| Los sistemas de tarjetas de memoria favorecen recuperar la respuesta antes de verla, no solo reconocerla. | Mantener el modo rápido, pero permitir escribir el significado para quien quiera una comprobación activa. | Hecho: respuesta escrita con tolerancia a mayúsculas y tildes, y programación distinta según acierto o error. |
