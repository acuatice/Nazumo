  ...
  return <div className="mx-auto max-w-xl pb-12 pt-6 sm:pt-12 animate-page-in">
    ...
    <section className="mt-6 rounded-[2rem] bg-white p-6 shadow-[0_18px_55px_rgba(52,24,114,.09)] sm:p-9">
      {profile ? <>
        ...
        <button type="button" onClick={clearLearnerProfile} className="mt-6 min-h-11 rounded-full border border-[var(--border)] px-5 text-sm font-bold transition hover:bg-[var(--nazumo-cream)]">Cerrar sesión</button>
      </> : <>
