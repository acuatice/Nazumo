...
export default function HiraganaPage() {
  return <div className="mx-auto max-w-4xl pb-10 pt-3 sm:pt-7 animate-page-in">
    <section className="nazumo-lavender-gradient relative -mx-4 overflow-hidden rounded-[0_0_2.25rem_2.25rem] px-4 pb-7 pt-7 min-[375px]:-mx-5 min-[375px]:px-5 sm:-mx-8 sm:px-8 sm:pb-10 lg:-mx-10 lg:px-10">
      ...
      <Image src="/brand/nazumo-hiragana.png" alt="Personaje de Nazumo" width={680} height={450} priority className="pointer-events-none absolute -right-16 top-8 h-40 w-60 object-cover object-center opacity-60 min-[375px]:top-1 min-[375px]:h-48 min-[375px]:w-72 sm:-right-2 sm:top-20 sm:h-64 sm:w-96 sm:opacity-95" />
      <HiraganaCourseHero />
    </section>
